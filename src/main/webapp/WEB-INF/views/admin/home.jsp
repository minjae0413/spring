  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-body p-0">
            ...
            <c:forEach var="memberVO" items="${latestMembers}">
                ...
                <!-- <img src="/resources/admin/dist/img/default-150x150.png;" alt="User Image"> 아래 onerror은 액박일때 대신 보여줄 이미지를 지정 -->
        ...
        <!-- //최근 등록한 회원 목록 -->
        <!-- 최근 게시물 리스트(공지사항+겔러리+QnA게시판) 현재 2개의 게시판이 나오게 됨 -->
        <!-- include와 import의 차이점: include는 소스를 조립 후 컴파일. import는 개별파일을 컴파일 후 조립 -->
